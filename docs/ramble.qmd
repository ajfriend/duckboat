...
Darkwing is a *small* DataFrame library...

Darkwing is etc. It is *small*, in that it is a light wrapper around the DuckDB API. Not much to learn and the library gets out of your way.